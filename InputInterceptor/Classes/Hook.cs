...
namespace InputInterceptorNS {
    ...
    public abstract class Hook<TCallbackStroke> : IDisposable {
        ...
        public delegate Boolean CallbackAction(Context context, Device device, ref TCallbackStroke stroke);
        ...
        protected abstract Boolean CallbackWrapper(Context context, Device device, ref Stroke stroke);
            ...
            while (this.Active) {
                ...
                if (InputInterceptor.Receive(this.Context, device, ref stroke, 1) > 0) {
                    ...
                    if (this.Active && this.Callback != null) {
                        try {
                            forwardKeyStroke = this.CallbackWrapper(this.Context, device, ref stroke);
